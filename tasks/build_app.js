...
gulp.task('bundle', () => {
	return Promise.all([
		...
		bundle(srcDir.path('minecraft/account_profile.js'),          destDir.path('minecraft/account_profile.js')),
		bundle(srcDir.path('minecraft/asset.js'),                    destDir.path('minecraft/asset.js')),
		bundle(srcDir.path('minecraft/asset_manager.js'),            destDir.path('minecraft/asset_manager.js')),
		bundle(srcDir.path('minecraft/instance.js'),                 destDir.path('minecraft/instance.js')),
